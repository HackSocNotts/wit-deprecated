  ...
  <div class="container">
    ...
    <div class="row">
      ...
      <div class="col-md-4 col-sm-1 col-xs-1">
        ...
        <p class="text-muted">In the morning we have a number of inspirational talks from notable women. After lunch we will have a series of workshops and a tradefair-style opportunity for networking.</p>
      </div>
